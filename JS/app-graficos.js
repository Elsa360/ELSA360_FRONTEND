...
durElvDistEntreno(dataDuracion,dataDesnivel,dataDistancia,dataLabels);

function durElvDistEntreno(dataDuracion,dataDesnivel,dataDistancia,dataLabels) {
  ...
  xaxis: {
    ...
    group: {
      ...
      groups: [
        ...
        { title: 'Macrociclo 3', cols: 24 },
        { title: 'Macrociclo 3', cols: 4 }
      ]
    }
  },
  yaxis: [{
