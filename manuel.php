...
<head>
  ...
  <meta name="description" content="En ELSA encuentras tu entrenamiento de cilismo integral y personalizado">
...
<div class="dropdown-shortcuts-list scrollable-container">
  ...
  <div class="row row-bordered overflow-visible g-0">
    ...
    <div class="dropdown-shortcuts-item col">
      ...
      <a href="app-planDeportivo.html" class="stretched-link">Plan deportivo</a>
...
<li>
  <a class="dropdown-item" href="auth-login-basic.html">
    ...
    <a class="align-middle" onclick="logout()" href="javascript:void(0);">Cerrar sesión</a>
  </a>
</li>
...
<div class="content-wrapper">
  ...
  <div class="container-fluid flex-grow-1 container-p-y">
      ...
      <div class="col-lg-8 mb-3 order-0">
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-3">
              <div class="card">
                ...
                <div class="mt-3">
                  ...
                  <small class="card-title mb-0 text-success"
                  style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="semanasDashboard">24 <small>Semanas</small>
                </small>
              </div>
          ...
          <div class="card">
            <div class="card-body pb-2">
              <span class=" fw-semibold mb-1">Disponibilidad semanal: &nbsp; <small
                class="card-title text-success mb-1" style="font-size: 18px;" id="hrSemanalDashboard"> 17 </small><small>
                  hrs</small></span>
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
          <div class="card">
            ...
            <div class="card-title d-flex align-items-start justify-content-between mb-0">
              ...
              style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="sesionesDashboard">34</small>
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
          <div class="card">
            ...
            <div class=" d-flex align-items-start justify-content-between mb-2">
              <div>
                ...
                title=" <span> h : m : s</span>" id="duracionTotalDashboard">81:26:17
              </small>
            </div>
          ...
          <small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400;">Promedio
            ...
            style="margin-top: 0px; font-size: 15px; font-weight: 600;" data-bs-toggle="tooltip"
            data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true"
            title=" <span> h : m : s</span>" id="promedioSesionDashboard">2:45:21
          </small>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
      <div class="card">
        ...
        <div class="card-title d-flex align-items-start justify-content-between mb-2">
          <div>
            ...
            <small class="card-title mb-0 text-success"
            style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="distanciaTotalDashboard">1,475 <small>Km</small>
          </small>
        </div>
        <div class="avatar flex-shrink-0 mb-0">
      ...
      <small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400;">Promedio
        de sesión: </small>
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="distPromedioSesionDashboard">87.5 <small>Km</small></small>
      </div>
    </div>
  </div>
  ...
  <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
    <div class="card">
      ...
      <div class="card-title d-flex align-items-start justify-content-between mb-2">
        <div>
          ...
          <small class="card-title mb-0 text-success"
          style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="desnivelDashboard">47,475 <small>m</small>
        </small>
      </div>
    ...
    <small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400;">Promedio
      de sesión: </small>
      <small class="card-title mb-0 text-success"
      style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="desnivelPromedioDashboard">1048.5 <small>m</small></small>
    </div>
  </div>
</div>
...
<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
  <div class="card">
    ...
    <div class="card-title d-flex align-items-start justify-content-between mb-2">
      <div>
        ...
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;">247,475 <small>Cal</small>
      </small>
    </div>
    <div class="avatar flex-shrink-0">
  ...
  <small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400;">Promedio
    de sesión: </small>
    <small class="card-title mb-0 text-success"
    style="margin-top: 0px; font-size: 15px; font-weight: 600;">648.5 <small>Cal</small></small>
  </div>
</div>
</div>
...
<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
    ...
    <div class="card-title d-flex align-items-start justify-content-between mb-2">
      <div>
        <Small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400; ">RPE
          Total:</Small>
          <small class="card-title mb-0 text-success"
          style="margin-top:0px; font-size: 15px; font-weight: 600;">119
  ...
  <small class="d-block mb-0" style="line-height: 16px; font-size: 15px; font-weight: 400;">Promedio
    de sesión: </small>
    <small class="card-title mb-0 text-success"
    style="margin-top: 0px; font-size: 15px; font-weight: 600;">648.5 </small>
  </div>
</div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-12 mb-3">
      <div class="card">
          ...
          <div class="d-flex justify-content-between">
            <div class="card-info">
              <h5 class="card-text">Requerimiento de calorías <small class="mt-1 mb-0"><span
                ...
                <div class="d-flex align-items-end mb-3">
                  <h6 class="card-title mb-0 me-2">GET = <span class="text-warning" id="GETdashboard"> 2750
                    Cal</span></h6>
                  </div>
            ...
            <div class="col-6 mb-3">
                    ...
                    <div class="card">
                      <div class="card-body" style="padding-right:12px; padding-left: 16px;">
                        <div class=" d-flex align-items-start justify-content-between mb-2">
                          <div>
                            <small class="d-block mb-0"
                            style="line-height: 16px; font-size: 15px; font-weight: 400;">Consumo de agua: </small>
                            <small class="card-title mb-0 text-success"
                      ...
                      <div class="d-flex align-items-end mb-0">
                        <h4 class="card-title mb-2 me-2" id="requerimientoLiquidos">0 Lts <button type="button"
                          class="btn" data-bs-toggle="modal" data-bs-target="#modalHidratacion"
                          style="padding: 0;"><i class='bx bx-info-circle'></i></button></h4>
                        </div>
              ...
              <div class="row">
                  ...
                  <div class="card">
                    ...
                    <div class=" d-flex align-items-start justify-content-between mb-2">
                      <div>
                        ...
                        <small class="card-title mb-0 text-success"
                        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="fmaxdashboard"> <small>PPM</small>
                      </small>
                    </div>
                ...
                <small class="card-title mb-0 text-success"
                style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="fcPromedioDashboard"> <small>PPM</small>
              </small>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class=" d-flex align-items-start justify-content-between mb-2">
              <div>
                ...
                Max:</small>
                <small class="card-title mb-0 text-success"
                style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="pMaxDashboard"> <small>W</small>
              </small>
            </div>
        ...
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="potAbsPromedioDashboard"><small>W</small>
      </small>
    </div>
  </div>
</div>
  ...
  <div class="card">
    ...
    <div class=" d-flex align-items-start justify-content-between mb-2">
      <div>
        ...
        Max:</small>
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="pRelMaxDashboard"> <small>W</small>
      </small>
    </div>
...
<small class="card-title mb-0 text-success"
style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="potRelPromedioDashboard"> <small>W</small>
</small>
</div>
</div>
</div>
...
<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
  <div class="card">
    ...
    <div class=" d-flex align-items-start justify-content-between mb-2">
      <div>
        ...
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="vMaxDashboard"> <small>Km/h</small>
      </small>
    </div>
  ...
  <small class="card-title mb-0 text-success"
  style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="velPromedioDashboard"> <small>Km/h</small>
</small>
</div>
</div>
</div>
...
<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-3">
  <div class="card">
    ...
    <div class=" d-flex align-items-start justify-content-between mb-2">
      <div>
        ...
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="cMaxDashboard"> <small>RPM</small>
      </small>
    </div>
  ...
  <small class="card-title mb-0 text-success"
  style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="cadePromedioDashboard"> <small>RPM</small>
</small>
</div>
</div>
</div>
...
<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-6 mb-2">
  <div class="card">
    ...
    <div class=" d-flex align-items-start justify-content-between mb-2">
      <div>
        ...
        <small class="card-title mb-0 text-success"
        style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="trabajoDashboard"> <small>KJ</small>
      </small>
    </div>
  ...
  <small class="card-title mb-0 text-success"
  style="margin-top: 0px; font-size: 15px; font-weight: 600;" id="trabajoPromedioDashboard"> <small>KJ</small>
</small>
</div>
</div>
</div>
    ...
    <div class="col-md-6 col-lg-4 mb-3">
      ...
      <div class="d-flex align-items-center justify-content-between mb-0" style="margin-left: 24px;">
        ...
        data-bs-placement="bottom" data-bs-html="true" title=" <span>
          FTP Absoluto </span>">
          FTP Abs. = <span class="text-success" id="ftpdashboard"></span> <small class="text-muted">W</small> </p>
          ...
          data-bs-offset="0,4" data-bs-placement="bottom" data-bs-html="true" title=" <span>
            FTP Relativo </span>">
            FTP Rel. = <span class="text-success" id="ftpReldashboard"></span> <small class="text-muted">W</small> </p>
          </div>
                  ...
                  <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div class="me-2">
                      ...
                      <div class="user-progress d-flex align-items-center gap-1">
                        <h6 class="mb-0"><span class="text-success">
                          < </span> <span class="text-success" id="zona1ftp"></span></h6>
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                          <h6 class="mb-0"><span class="text-success" id="zona2ftp"></span></h6>
                          <small class="text-muted">W</small>
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                          <h6 class="mb-0"><span class="text-success" id="zona3ftp"></span></h6>
                          <small class="text-muted">W</small>
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                          <h6 class="mb-0"><span class="text-success" id="zona4ftp"></span></h6>
                          <small class="text-muted">W</small>
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                          <h6 class="mb-0"><span class="text-success" id="zona5ftp"></span></h6>
                          <small class="text-muted">W</small>
                    ...
                    <li class="d-flex">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        ...
                        <div class="user-progress d-flex align-items-center gap-1">
                          <h6 class="mb-0"> <span class="text-success" id="zona6ftp"></span></h6>
                          <small class="text-muted">W</small>
            ...
            <div class="col-md-6 col-lg-4 mb-3">
              <div class="card h-100">
                ...
                <div class="mb-0" style="margin-left: 20px;">
                  <p style="margin: 0; font-weight: 500;">FTHR = <span class="text-success" id="fhtrdashboard"></span> <small
                    ...
                    <li class="d-flex mb-4 pb-1">
                      ...
                      <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div class="me-2">
                          ...
                          <div class="user-progress d-flex align-items-center gap-1">
                            <h6 class="mb-0"><span class="text-success">
                              < </span> <span class="text-success" id="zona1fhtr"></span></h6>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0"><span class="text-success" id="zona2fhtr"></span></h6>
                              <small class="text-muted">PPM</small>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0"><span class="text-success" id="zona3fhtr"></span></h6>
                              <small class="text-muted">PPM</small>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0"><span class="text-success" id="zona4fhtr"></span></h6>
                              <small class="text-muted">PPM</small>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0"><span class="text-success" id="zona5fhtr"></span></h6>
                              <small class="text-muted">PPM</small>
                        ...
                        <li class="d-flex">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress d-flex align-items-center gap-1">
                              <h6 class="mb-0"> <span class="text-success" id="zona6fhtr"></span> </h6>
                              <small class="text-muted">PPM</small>
